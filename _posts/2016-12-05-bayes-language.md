Bayesian Language
-----
I have tried to conquer Bayesian modeling several times since 2010 (in the middle of a PhD term which I eventually dropped out of), read a lot paper, couple of books, and took some online classes. Yes, you can remember math terms, you may follow what they say in the paper when you are reading it, you may be able to derive the equations just like they do. But what's hard is to really understand what's going on behind those equations, without which you are bound to forget what you think you know after a while. Therefore you might need to repeat the learning process, however only to find you stuck in a loop.
